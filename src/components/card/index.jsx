export default function Card() {
    return (
        <div className="w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl bg-white rounded-lg p-6 shadow-md transition hover:shadow-lg">
            ...
            <p className="my-4 text-gray-700 font-semibold text-center sm:text-left">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque iste odit tempore eaque, modi officiis.</p>
